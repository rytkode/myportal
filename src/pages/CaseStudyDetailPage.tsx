...
const caseStudies: CaseStudy[] = [
  {
    ...
    testimonial: {
      quote: 'The RYTKODE team demonstrated exceptional expertise in healthcare data migration. They understood our unique compliance requirements and delivered a solution that not only met our technical needs but also improved our patient care capabilities.',
  ...
  },
  {
    ...
    testimonial: {
      quote: 'The transformation of our e-commerce platform has been nothing short of remarkable. RYTKODE delivered a solution that not only looks great but has significantly improved our bottom line. The attention to detail and focus on conversion optimization was impressive.',
      author: 'Michael Wong',
  ...
  },
  {
    ...
    testimonial: {
      quote: 'The AI solution RYTKODE implemented has transformed our customer service operations. We\'re now able to provide faster, more accurate responses while allowing our agents to focus on complex issues where they add the most value. The ROI has exceeded our expectations.',
