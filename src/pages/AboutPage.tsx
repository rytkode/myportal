        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <img
                ...
                alt="RYTKODE team collaborating"
          ...
          >
            ...
            <div className="space-y-4 text-neutral-700">
              <p>
                Founded in 2015, RYTKODE began with a simple mission: to bridge the gap between business challenges and technology solutions. Our founder, Alex Thompson, recognized that many organizations struggled to harness the full potential of technology due to a lack of strategic guidance and technical expertise.
              </p>
