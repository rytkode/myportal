            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@rytkode.com" className="text-neutral-600 hover:text-primary-900 transition-colors">
                    info@rytkode.com
                  </a>
                </div>
              </div>
        ...
        <div className="relative h-[400px] rounded-xl overflow-hidden shadow-md">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm">
              <h3 className="text-xl font-bold mb-2">rytkode Headquarters</h3>
